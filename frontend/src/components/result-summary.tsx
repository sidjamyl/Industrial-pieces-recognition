...
import { Check, CircleX, RotateCcw, Sparkles } from "lucide-react";
...
export function ResultSummary({
  ...
  const isCatalogMatch = result.ranking[0].score >= 0.4;
      ...
      <div className="flex flex-col justify-center">
        {isCatalogMatch ? (
          ...
          <div className="rounded-[28px] border border-amber-200 bg-amber-50 p-7">
            ...
            <p className="mt-6 text-xs font-semibold tracking-[0.08em] text-amber-700 uppercase">
              Aucune correspondance
            </p>
            <h2 className="mt-3 text-3xl leading-tight font-semibold tracking-[-0.04em] text-[var(--ink)]">
              Cette image ne fait pas partie du catalogue de pièces.
            </h2>
            <p className="mt-4 text-sm leading-6 text-[var(--muted)]">
              Essayez une autre photo ou ajoutez cette référence depuis l’espace
              d’administration.
            </p>
          </div>
        )}
